...
export type Database = {
  public: {
    Tables: {
      ...
      invoices: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "invoices_link_id_fkey";
            columns: ["link_id"];
            isOneToOne: false;
      ...
      payment_links: {
        Row: {
          amount_usdc: string;
          auth_deadline: number | null;
          created_at: string;
          deactivated_at: string | null;
          expires_at: string | null;
          id: string;
          label: string | null;
          link_chain_id: string | null;
          paid_count: number;
          slug: string;
          updated_at: string;
          vendor_auth_sig: string | null;
          vendor_id: string;
          view_count: number;
        };
        Insert: {
    ...
    Functions: {
      ...
      increment_link_view: { Args: { p_slug: string }; Returns: undefined };
