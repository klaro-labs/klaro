...
export const metadata: Metadata = {
  ...
  description: "Open-source on-chain reputation signal. 11 audited event kinds, signed weights, summed by VendorReputation.sol.",
};
...
type FactorSign = "positive" | "negative";
  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg)] text-[var(--color-ink)]">
      ...
      <PageHero
        ...
        sub="Klaro emits 11 signed event kinds to an on-chain VendorReputation contract. Anyone can sum them. There is no model — the score is the math."
        ctas={[
      ...
      <section className="klaro-container pb-20">
        ...
        <h2 className="mt-4 font-display text-[clamp(2rem,4vw,3rem)] font-semibold leading-[1.1] tracking-tight">
          Eleven event kinds. All emitted on-chain.
        </h2>
